...
const chartConfig = {
  amount: { label: "Payment Amount", color: "var(--chart-1)" },
    ...
    <Drawer swipeDirection={isMobile ? "down" : "right"}>
      ...
      <DrawerContent>
        <DrawerHeader className="gap-1">
          ...
          <DrawerDescription>Payment details and transaction history</DrawerDescription>
        </DrawerHeader>
                  ...
                  <TableRow>
                    <TableCell colSpan={columns.length} className="h-24 text-center">
                      <div className="flex flex-col items-center gap-2 text-muted-foreground">
                        ...
                        <p>No {activeTab !== "all" ? activeTab : ""} payments yet.</p>
                      </div>
                    </TableCell>
                  </TableRow>
                )}
